        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="my_sons_attendance_history.php"><i class="fa fa-circle-o"></i> My Son's Attendance
                            History</a></li>
                </ul>
            </li>
            <li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="my_sons_exam_marks_history.php"><i class="fa fa-circle-o"></i> My Son's Exam Marks
                            History</a></li>
                    <li><a href="my_sons_exam_timetable.php"><i class="fa fa-circle-o"></i>My Son's Exam Timetable</a>
                    </li>
                </ul>
            </li>
        </ul>
