...
?>
                                        ...
                                        <li>
                                            <a href="#"
                                                onClick="viewNotifications('<?php echo $std_index; ?> ','<?php echo $due_month; ?>','<?php echo $due_year; ?>','<?php echo $notifi_id; ?>')">
                                                <i class="fa fa-users text-aqua"></i> <?php echo $std_name; ?> didn't
                                                paid monthly fee for <?php echo $due_month; ?>
                                            </a>
                                        </li>
                                        <?php }  ?>
                                    </ul>
...
?>
                        ...
                        function viewNotifications(std_index, due_month, due_year, notifications_id) {
                            ...
                            xhttp.open("GET", "student_due_payment.php?std_index=" + std_index + "&due_month=" +
                                due_month + "&due_year=" + due_year, true);
                            xhttp.send();
...
?>
                        ...
                        <li class="dropdown messages-menu" id="friend_request">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                onClick="showFriendRequest('<?php echo $my_index; ?>','<?php echo $my_type; ?>')">
                        ...
                        function showFriendRequest(my_index, my_type) {
                            ...
                            xhttp.open("GET", "show_friend_request.php?my_index=" + my_index + "&my_type=" + my_type,
                                true);
                            xhttp.send();
                        ...
                        function friendProfile(friend_type, friend_index) {
                            ...
                            xhttp.open("GET", "friend_profile.php?friend_type=" + friend_type + "&friend_index=" +
                                friend_index, true);
                            xhttp.send();
                        ...
                        function confirmFriend(my_index, my_type, friend_index) {
                            ...
                            xhttp.open("GET", "../model/confirm_friends.php?my_index=" + my_index + "&friend_index=" +
...
?>
                                        ...
                                        <li>
                                            ...
                                            <a href="<?php echo $file_path; ?>"
                                                onClick="msgRead('<?php echo $index; ?>','<?php echo $conversation_id; ?>','<?php echo $friend_index; ?>','<?php echo $type; ?>')">
                                                <div class="pull-left">
                        ...
                        function msgRead(conversation_id, friend_index, my_index, my_type) {
                            ...
                            xhttp.open("GET", "../model/confirm_msg_read.php?conversation_id=" + conversation_id +
                                "&friend_index=" + friend_index + "&do=" + do1, true);
                            xhttp.send(); //MSK-000127-Ajax End
                        ...
                        function unreadMsgCount(my_index, my_type) {
                            ...
                            intervalID1 = setInterval(function() {
                                ...
                                $('#unread_msg').load("unread_msg.php?my_index=" + my_index + "&my_type=" +
                                    my_type + "");
...
?>
        ...
        <div class="modal msk-fade" id="deleteConfirmReq" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="#" style='margin-left:10px;' id="btnYesReq"
