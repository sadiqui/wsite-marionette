...
?>
<div class="modal msk-fade" id="modalviewSalary" tabindex="-1" role="dialog" aria-labelledby="insert_alert1"
...
?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <img id="photo2" alt="User Pic" src="../<?php echo $image_name; ?>"
...
?>
                        ...
                        <div class="panel-footer bg-gray-light">
                            ...
                            <span class="pull-right">
                                ...
                                <button id="btnPaid" onClick="addSalary1(this)" value="" class="btn btn-success">+Add
                                    Payment </button>
