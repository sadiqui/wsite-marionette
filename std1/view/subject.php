...
<div class="content-wrapper">
                    ...
                    <form role="form" action="../index.php" method="post">
                        <div class="box-body">
                            <div class="form-group" id="divSubject">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Enter Subject name"
    ...
    $("form").submit(function(e) {
        ...
        if (name == '') {
            ...
            $('#divSubject').append(
                '<span id="spanName" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The subject is required" ></span>'
                );
...
?>
    ...
    <div class="modal msk-fade" id="modalUpdateform" tabindex="-1" role="dialog" aria-labelledby="modalUpdateform"
        aria-hidden="true">
                    ...
                    <div class="col-md-6">
                        <div class="panel">
                            ...
                            <div class="panel-footer bg-gray-light">
                                ...
                                <button type="button" onClick="Updatesubject(this)" id="btnSubmit1" class="btn btn-info"
    ...
    function Updatesubject() {
        ...
        if (name1 == '') {
            ...
            $('#divSubjectUpdate').append(
                '<span id="spanSubjectUpdate" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The subject is required" ></span>'
                );
    ...
    $('#btnYes').click(function() {
        ...
        xhttp.open("GET", "../model/delete_record.php?id=" + id + "&do=" + do1 + "&table_name=" + table_name +
