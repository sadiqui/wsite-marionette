                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="../index.php" method="post" enctype="multipart/form-data" id="form1"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="divIndexNumber">
                                        ...
                                        <div class="col-xs-9" id="divIndexNumber1">
                                            <input type="text" class="form-control" placeholder="Enter index number"
                                                name="index_number" id="index_number" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="divIName">
                                        ...
                                        <div class="col-xs-9" id="divIName1">
                                            <input type="text" class="form-control"
                                                placeholder="Enter name with initials" name="i_name" id="i_name"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="divGIndexNumber">
                                        ...
                                        <div class="col-xs-9" id="divGIndexNumber1">
                                            <input type="text" class="form-control" placeholder="Enter index number"
                                                name="g_index" id="g_index" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group" id="divGFullName">
                                        ...
                                        <div class="col-xs-9" id="divGFullName1">
                                            <input type="text" class="form-control" placeholder="Enter full name"
                                                name="g_full_name" id="g_full_name" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group" id="divGIName">
                                        ...
                                        <div class="col-xs-9" id="divGIName1">
                                            <input type="text" class="form-control"
                                                placeholder="Enter name with initials" name="g_i_name" id="g_i_name"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group" id="divGAddress">
                                        ...
                                        <div class="col-xs-9" id="divGAddress1">
                                            <input type="text" class="form-control" placeholder="Enter address"
                                                name="g_address" id="g_address" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group" id="divGEmail">
                                        ...
                                        <div class="col-xs-9" id="divGEmail1">
                                            <input type="text" class="form-control" placeholder="Enter email address"
                                                name="g_email" id="g_email" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-7">
                                            ...
                                            <div class="form-group" id="divGDOB">
                                                ...
                                                <div class="col-xs-7" id="divGDOB1">
                                                    <input type="text" class="form-control" id="g_b_date"
                                                        name="g_b_date">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xs-5">
                                            <div class="form-group" id="divGPhoto">
                                                ...
                                                <div class="col-xs-3" id="divGPhoto1" style="height:150px;">
                                                    ...
                                                    <input type="file" name="g_fileToUpload" id="g_fileToUpload"
                                                        style="margin-top:7px;" />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="box-footer text-right">
                            ...
                            <button style="width:150px;" type="submit" class="btn text-right btn-success asd"
                                id="btnSubmit">Next</button><br>
...
?>
    ...
    $('#g_fileToUpload').change(function() {
        ...
        if ($.inArray(ext, ['png', 'jpg', 'jpeg']) == -1) {
            ...
            $('#divGPhoto1').append(
                '<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"                                title="The file type is not allowed" ></span>'
                );
            ...
            if (fileSize > maxSize) {
                ...
                $('#divGPhoto1').addClass('has-feedback');
                $('#divGPhoto1').append(
                    '<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="The file size is too large" ></span>'
                    );
    ...
    $("form").submit(function(e) {
        ...
        if (g_index_number == '') {
            ...
            $('#divGIndexNumber').append(
                '<span id="spanGIndexNumber" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" 									 data-toggle="tooltip" title="The index number is required" ></span>'
                );
        ...
        if (g_full_name == '') {
            ...
            $('#divGFullName').append(
                '<span id="spanGFullName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The full name is required" ></span>'
                );
        ...
        if (g_i_name == '') {
            ...
            $('#divGIName').append(
                '<span id="spanGIName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The initials name is required" ></span>'
                );
        ...
        if (g_address == '') {
            ...
            $('#divGAddress').append(
                '<span id="spanGAddress" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The address is required" ></span>'
                );
        ...
        if (g_gender == 'Select Gender') {
            ...
            $('#divGGender1').append(
                '<span id="spanGGender" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The gender is required" ></span>'
                );
        ...
        if (b_date == '') {
            ...
            $('#divDOB1').append(
                '<span id="spanDOB" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The date of birth is required" ></span>'
                );
        ...
        if (g_b_date == '') {
            ...
            $('#divGDOB1').append(
                '<span id="spanGDOB" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The date of birth is required" ></span>'
                );
        ...
        if (g_email == '') {
            ...
            $('#divGEmail1').append(
                '<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The email address is required" ></span>'
                );
            ...
            if (mailformat.test(g_email) == false) {
                ...
                $('#divGEmail').addClass('has-error has-feedback');
                $('#divGEmail1').append(
                    '<span id="spanGEmail" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Enter valid email address" ></span>'
                    );
        ...
        if (g_photo == '') {
            ...
            $('#divGPhoto1').addClass('has-feedback');
            $('#divGPhoto1').append(
                '<span id="spanGPhoto" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The image is required" ></span>'
                );
        ...
        if (g_phone == '') {
            ...
            $('#divGPhone1').append(
                '<span id="spanGPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The phone number is required" ></span>'
                );
            ...
            if (telformat.test(g_phone) == false) {
                ...
                $('#divGPhone1').addClass('has-error has-feedback');
                $('#divGPhone1').append(
                    '<span id="spanGPhone" class="glyphicon glyphicon-remove form-control-feedback msk-set-color-tooltip" data-toggle="tooltip"    title="Enter valid phone number" ></span>'
                    );
                ...
                $("#g_phone").keydown(function() {
                    ...
                    setTimeout(function() {
                        ...
                        if (telformat.test(afterVal) == true) {
                            ...
                            $('#divGPhone1').append(
                                '<span id="spanGPhone" class="glyphicon glyphicon-ok form-control-feedback"></span>'
                                );
        ...
        if (index_number == '' || g_index_number == '' || full_name == '' || g_full_name == '' || i_name ==
            '' || g_i_name == '' || address == '' || g_address == '' || gender == 'Select Gender' || g_gender ==
            'Select Gender' || b_date == '' || g_b_date == '' || email == '' || mailformat.test(email) ==
            false || g_email == '' || mailformat.test(g_email) == false || telformat.test(phone) == false ||
            telformat.test(g_phone) == false || photo == '' || g_photo == '' || phone == '' || g_phone == '') {
    ...
    <div class="modal msk-fade" id="modalSelectGrade" tabindex="-1" role="dialog" aria-labelledby="modalSelectGrade"
...
?>
                                            <option value="<?php echo $row["id"]; ?>" data-id="">
...
?>
    ...
    function insertSubject() {
        ...
        xhttp.open("GET", "student_first_payment.php?index=" + index + "&grade=" + grade + "&id=" + JSON.stringify(
            yourArray), true);
    ...
    function addSPayment() {
        ...
        xhttp.open("GET", "../model/add_student_first_payment.php?index=" + index + "&afee=" + aFee + "&totalsfee=" +
            totalSFee + "&inv_num=" + inv_num, true);
