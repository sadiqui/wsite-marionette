...
?>
<div class="modal msk-fade" id="edit_examMark" tabindex="-1" role="dialog" aria-labelledby="modalInsertform"
    aria-hidden="true">
...
?>
                                            <tr id="tr_<?php echo $count; ?>">
                                                <input type="hidden" name="subject_id[]"
                                                    id="eSubject_id_<?php echo $count; ?>"
                                                    value="<?php echo $row2['s_id']; ?>">
                                                <input type="hidden" name="grade" value="<?php echo $grade_id; ?>" />
                                                <input type="hidden" name="exam_id" value="<?php echo $exam_id; ?>" />
                                                <input type="hidden" name="id"
                                                    value="<?php echo $row2['std_emark_id']; ?>" />
                                                <td id="eSubject_td_<?php echo $count; ?>">
                                                    <?php echo $row2['s_name']; ?></td>
                                                <td id="eMark_td_<?php echo $count; ?>"><input type="text"
                                                        name="exam_mark[]" value="<?php echo $row2['std_emark']; ?>"
                                                        id="exam_mark_<?php echo $count; ?>"></td>
                                            </tr>
                                            <?php	}} ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="panel-footer bg-blue-active">
                                ...
                                <button type="submit" class="btn btn-info btnS" id="btnSubmit3"
