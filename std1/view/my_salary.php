...
?>
                                <tr>
                                    ...
                                    <!--MSK-000115-td3-->
                                    <td id="td_status_<?php echo $count; ?>"><?php echo $row['_status']; ?></td>
                                    <!--MSK-000115-td4-->
                                    <td id="td_paid_<?php echo $count; ?>"><?php echo $row['paid']; ?></td>
                                    <td id="td_date_<?php echo $count; ?>"><?php echo $row['date']; ?></td>
                                    <td>
                                        <!--MSK-00102-->
                                        <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs"
                                            data-id="<?php echo $index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $count; ?>">View
                                            Details</a>
                                        <a href="#" onClick="showModal3(this)" class="btn btn-success btn-xs"
                                            data-id="<?php echo $index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $count; ?>">View
                                            Invoice</a>
                                    </td>
                                </tr>
    ...
    function showModal3(viewINV) {
        ...
        xhttp.open("GET", "teacher_salary_invoice1.php?index=" + index + "&desc=" + desc + "&paid=" + paid + "&year=" +
            year + "&month=" + month + "&date=" + date, true);
        xhttp.send(); //MSK-00105-Ajax End
