...
<div class="modal msk-fade" id="modalviewEvent5" tabindex="-1" role="dialog" aria-labelledby="insert_alert1"
            ...
            <div class="row">
                <div class="panel">
                    ...
                    <div class="panel-heading bg-orange">
                        <button type="button" onClick="showAllNotfi1()" class="close" data-dismiss="modal"
