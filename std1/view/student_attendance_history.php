...
?>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" id="btnSubmit" class="btn btn-primary"
                            onClick="showStudent(this)">Submit</button>
                        <!--MSK-000108-->
                    </div>
                </div><!-- /.box -->
            </div>
    ...
    function showStudent() {
        ...
        if (month == 'Select Month') {
            ...
            $('#divMonth1').append(
                '<span id="spanMonth" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The month is required" ></span>'
                );
