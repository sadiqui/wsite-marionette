        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="my_attendance_history2.php"><i class="fa fa-circle-o"></i>My Attendance History</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="my_student_exam_marks.php"><i class="fa fa-circle-o"></i> My Student Exam Marks</a>
                    </li>
                    <li><a href="my_student_exam_marks_history.php"><i class="fa fa-circle-o"></i> My Student Exam Marks
                            History</a></li>
