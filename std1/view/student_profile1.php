...
<div class="modal msk-fade" id="modalviewStudent" tabindex="-1" role="dialog" aria-labelledby="insert_alert1"
                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-heading bg-aqua-active">
                            <button type="button" class="close" onClick="viewAllNotifi()" data-dismiss="modal"
                        ...
                        <div class="panel-footer">
                            ...
                            <span class="pull-right">
                                <a href="#modalUpdateform" onClick="showModal(this)"
                                    data-original-title="Edit this user" id="id3" data-toggle="modal" type="button"
