...
@media print {
    ...
    #modalInsertform #btn1,
    #modalInsertform .panel-footer,
    #modalInsertform .msk-heading {
        display: none;
...
#modalViewPettyCash h2,
#modalViewPettyCash h3 {
    margin-top: 0;
    color: #8860a7;
...
@media print {
    ...
    #modalViewPettyCash #btn1,
    #modalViewPettyCash .panel-footer,
    #modalViewPettyCash .msk-heading {
        display: none;
            ...
            <div class="col-md-10">
                <div class="box">
                    <div class="box-header">
                        <a href="#modalInsertform" onClick="showModal()" class="btn btn-success btn-sm pull-right"
                            data-id="" data-toggle="modal">Add <span class="glyphicon glyphicon-plus"></span></a>
                        <!-- MSK-00094-->
...
?>
                                <tr>
                                    ...
                                    <!--MSK-000115-td4-->
                                    <td id="td_paid_<?php echo $count; ?>"><?php echo $paid; ?></td>
                                    <td>
                                        <a href="#" onClick="showModal2(this)" class="btn btn-info btn-xs"
                                            data-id="<?php echo $row['id']; ?>,<?php echo $index; ?>">View Details</a>
                                        <a href="#" id="aApprove_<?php echo $count; ?>" onClick=""
                                            class="confirm-approve btn btn-warning btn-xs"
                                            data-id="<?php echo $row['id']; ?>,<?php echo $index; ?>">Approve</a>
                                    </td>
                                </tr>
                                <?php } }  ?>
                            </tbody>
    ...
    <div class="modal msk-fade" id="modalInsertform" tabindex="-1" role="dialog" aria-labelledby="insert_alert1"
