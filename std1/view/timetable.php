            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                $("#subject").change(function() { //MSK-000120
                    ...
                    xhttp1.onreadystatechange = function() {
                        ...
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            document.getElementById('teacher').innerHTML = this
                            .responseText; //MSK-000123

                        }

                    };

                    xhttp1.open("GET", "../model/get_teacher_timetable.php?subject=" + subject + "&grade=" +
                        Id, true);
                ...
                $("form").submit(function(e) {
                    ...
                    if (day == 'Select Day') {
                        ...
                        $('#divDay').append(
                            '<span id="spanDay" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The day is required" ></span>'
                            );
                    ...
                    if (subject == 'Select Subject') {
                        ...
                        $('#divSubject').append(
                            '<span id="spanSubject" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The subject is required" ></span>'
                            );
                    ...
                    if (teacher == 'Select Teacher') {
                        ...
                        $('#divTeacher').append(
                            '<span id="spanTeacher" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The teacher is required" ></span>'
                            );
                    ...
                    if (classroom == 'Select Classroom') {
                        ...
                        $('#divClassroom').append(
                            '<span id="spanClassroom" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The classroom is required" ></span>'
                            );
                    ...
                    if (start_time == '') {
                        ...
                        $('#divStartTime').append(
                            '<span id="spanStartTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The start time is required" ></span>'
                            );
                    ...
                    if (end_time == '') {
                        ...
                        $('#divEndTime').append(
                            '<span id="spanEndTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The end time is required" ></span>'
                            );
                    ...
                    if (day == 'Select Day' || subject == 'Select Subject' || teacher == 'Select Teacher' ||
                        classroom == 'Select Classroom' || start_time == '' || end_time == '') {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        $("#subject1").change(function() { //MSK-000141
                            ...
                            xhttp1.onreadystatechange = function() {
                                ...
                                if (this.readyState == 4 && this.status == 200) {
                                    ...
                                    document.getElementById('teacher1').innerHTML = this
                                        .responseText; //MSK-000144

                                }

                            };

                            xhttp1.open("GET", "../model/get_teacher_timetable.php?subject=" + subject +
                                "&grade=" + grade, true);
                        ...
                        $("form").submit(function(e) { //MSK-000147-form submit
                            ...
                            if (teacher == 'Select Teacher') {
                                ...
                                $('#divUpdateTeacher').append(
                                    '<span id="spanUpdateTeacher" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="The teacher is required" ></span>'
                                    );
                            ...
                            if (start_time == '') {
                                ...
                                $('#divUpdateSTime').append(
                                    '<span id="spanUpdateSTime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="The start time is required" ></span>'
                                    );
                            ...
                            if (end_time == '') {
                                ...
                                $('#divUpdateETime').append(
                                    '<span id="spanUpdateETime" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip" title="The end time is required" ></span>'
                                    );
...
?>
    ...
    <div class="modal msk-fade " id="deleteConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#" style='margin-left:10px;' id="btnYes"
                        class="deletebtn btn btn-danger col-sm-2 pull-right">Yes</a><!-- MSK-000154 -->
    ...
    $('#btnYes').click(function() { //MSK-000155
                ...
                if (myArray[0] == 1) { //MSK-000158
                    ...
                    xhttp1.onreadystatechange = function() {
                        ...
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            document.getElementById('table1').innerHTML = this
                            .responseText; //MSK-000160
        ...
        xhttp.open("GET", "../model/delete_record.php?id=" + id + "&do=" + do1 + "&table_name=" + table_name1 +
