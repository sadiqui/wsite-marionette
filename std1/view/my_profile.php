                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" id="my_profile">
                            <div class="col-md-3">
                                <img id="photo2" alt="User Pic" src="../<?php echo $image; ?>"
                    ...
                    <div class="panel-footer text-right" id="panel_footer">
                        <a href="#" onClick="editMyProfile('<?php echo $index; ?>')" type="button"
                            class="btn btn-sm btn-warning" id="btnEdit"><i class="glyphicon glyphicon-edit"></i></a>
                        <!--MSK-00151-->
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    $('[type="file"]').change(function() {
                        ...
                        if ($.inArray(ext, ['png', 'jpg', 'jpeg']) == -1) {
                            ...
                            if (fileSize > maxSize) {
                                ...
                                $('#divPhoto').addClass('has-error has-feedback');
                                $('#divPhoto').append(
                                    '<span id="spanPhoto1" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip" title="The file size is too large" ></span>'
                                );
                    ...
                    $("form").submit(function(e) {
                        ...
                        if (i_name == '') {
                            ...
                            $('#tdIName2').append(
                                '<span id="spanIName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"    title="The intial name is required" ></span>'
                            );
                        ...
                        if (g_name == '') {
                            ...
                            $('#tdGName2').append(
                                '<span id="spanGName" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"   title="The guardians name is required" ></span>'
                            );
                        ...
                        if (g_address == '') {
                            ...
                            $('#tdGAddress2').append(
                                '<span id="spanGAddress" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"   title="The guardians name is required" ></span>'
                            );
                        ...
                        if (phone == '') {
                            ...
                            if (telformat.test(phone) == false) {
                                ...
                                $("#phone1").keydown(function() {
                                    ...
                                    var $field = $(this);
                                    var beforeVal = $field
                                        .val(); // this is the value before the keypress

                                    setTimeout(function() {

                                        var afterVal = $field
                                            .val(); // this is the value after the keypress

                                        if (telformat.test(afterVal) == true) {
                                            //MSK-00106-phone
                                            $("#btnUpdate").attr("disabled", false);
                                            $('#tdPhone2').removeClass(
                        ...
                        if (email == '') {
                            ...
                            if (mailformat.test(email) == false) {
                                ...
                                $("#email1").keydown(function() {
                                    //MSK-00109-email
                                    var $field = $(
                                        this); // this is the value before the keypress
                                ...
                                $("#g_email1").keydown(function() {
                                    ...
                                    setTimeout(function() {
                                        ...
                                        if (mailformat.test(afterVal) == true) {
                                            //MSK-00110-email
                                            $("#btnUpdate").attr("disabled", false);
                                            $('#tdGEmail2').removeClass(
                                                'has-error has-feedback');
                                            $('#spanGEmail').remove();
                                            $('#tdGEmail2').addClass(
                                                'has-success has-feedback');
                                            $('#tdGEmail2').append(
                                                '<span id="spanGEmail" class="glyphicon glyphicon-ok form-control-feedback"></span>'
                                            );
                        ...
                        if (password == '') {
                            ...
                            $('#tdPassword2').append(
                                '<span id="spanPassword" class="glyphicon glyphicon-remove form-control-feedback msk-set-width-tooltip" data-toggle="tooltip"   title="The password is required" ></span>'
                            );
                        ...
                        if (full_name == '' || i_name == '' || address == '' || phone == '' || telformat
                            .test(phone) == false || email == '' || mailformat.test(email) == false ||
                            password == '' || g_name == '' || g_address == '' || g_phone == '' ||
                            telformat.test(g_phone) == false || g_email == '' || mailformat.test(
                                g_email) == false) {
