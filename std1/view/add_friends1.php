...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row" id="table1">
            <!-- after delete methanata thamay overite karanne view_classroom table -->
            <div class="col-md-8">
                <div class="box">
...
?>
                        <div class="">
                            <a href="#"
                                onClick="showFriends('<?php echo $my_type; ?>','Student','<?php echo $my_index; ?>')"
                                class="btn btn-md bg-navy-active" data-id=""><i class="fa fa-user-plus"
                                    aria-hidden="true">Student</i></a>
                            <a href="#"
                                onClick="showFriends('<?php echo $my_type; ?>','Teacher','<?php echo $my_index; ?>')"
                                class="btn btn-md bg-orange-active" data-id=""><i class="fa fa-user-plus"
                                    aria-hidden="true">Teachers</i></a>
                            <a href="#"
                                onClick="showFriends('<?php echo $my_type; ?>','Admin','<?php echo $my_index; ?>')"
                                class="btn btn-md bg-green-active" data-id=""><i class="fa fa-user-plus"
                                    aria-hidden="true">Admin</i></a>
                        </div>
...
?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#"
                                            onClick="friendProfile('Student','<?php echo $friend_index; ?>')"><?php echo $name; ?>
                                        </a><br>
...
?>
    ...
    function showFriends(my_type, friend_type, my_index) {
        ...
        xhttp.open("GET", "find_friends.php?my_type=" + my_type + "&friend_type=" + friend_type + "&my_index=" +
            my_index, true);
    ...
    function new123(my_type, friend_type, my_index) {
        ...
        intervalID7 = setInterval(function() {
            ...
            $('#tBodyFriends').load("find_friends.php?my_type=" + my_type + "&friend_type=" + friend_type +
                "&my_index=" + my_index + "");
...
?>
    ...
    function addFriends(aFriend) {
        ...
        xhttp.open("GET", "../model/add_friends.php?my_type=" + my_type + "&my_index=" + my_index + "&friend_type=" +
            friend_type + "&friend_index=" + friend_index + "&do=" + do1, true);
        xhttp.send(); //MSK-00149--End Ajax
    ...
    function confirmFriend1(cFriend) {
        ...
        xhttp.open("GET", "../model/confirm_friends.php?my_index=" + my_index + "&friend_index=" + friend_index +
            "&do=" + do1, true);
        xhttp.send();
        new123(my_type, friend_type, my_index);
    };
