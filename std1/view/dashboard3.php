                ...
                new Chart(document.getElementById("barChart"), {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            backgroundColor: ["#e80a68", "#d74340", "#8e3d87", "#40b9d7", "#26ab8d",
                                "#7e5c3e", "#3e447e", "#638e3d", "#766677", "#f35df8", "#e49e23",
                                "#f68b98"
                            ],
...
?>
        ...
        function ShowEvents(status, my_index, my_type) {
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    for (var i = 0; i < count1; i++) {
                        ...
                        for (var j = 0; j <= count; j++) {
                            ...
                            $("#td_" + k).append('<div class="div-event-c" style="background-color:' + color[i] +
                                '"><a id="event_"+' + [i] +
                                ' style="color:white;" href="#" onclick="showEvent(' + event_id[i] +
                                ')"><i class="fa fa-calendar" aria-hidden="true"></i></a></div>');
            ...
            xhttp.open("GET", "all_events1.php?year=" + y1 + "&month=" + m3 + "&my_type=" + my_type + "&my_index=" +
                my_index, true);
...
?>
        <div class="row" id="table1">
            ...
            <div class="col-md-12">
                <center>
                    <h4 class="box-title">My Son's Timetable</h4>
                </center>
                <div class="box">
