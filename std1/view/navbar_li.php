...
?>
    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
        onClick="showNavBar('<?php echo $my_index; ?>','<?php echo $my_type; ?>')">
...
?>
                    <a href="#">
                        ...
                        <button
                            onClick="confirmFriend('<?php echo $my_index; ?>','<?php echo $my_type; ?>','<?php echo $friend_index; ?>')"
                            class="btn btn-xs bg-green-active"><i class="fa fa-user-plus" aria-hidden="true">
                                Confirm</i></button>
                        <button href="#" class="confirm-delete btn btn-xs btn-danger"
                            data-id="<?php echo $my_index; ?>,<?php echo $friend_type; ?>,<?php echo $friend_index; ?>"><i
                                class="fa fa-user-plus" aria-hidden="true"> Delete Request</i></button>
                    </a>
                    <?php } } ?>
