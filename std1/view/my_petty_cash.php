            ...
            <div class="col-md-10">
                <div class="box">
                    <div class="box-header">
                        <a href="#modalInsertform" class="btn btn-success btn-sm pull-right" data-id=""
                            data-toggle="modal">Add <span class="glyphicon glyphicon-plus"></span></a><!-- MSK-00094-->
...
?>
        ...
        function addNewRow() {
            ...
            var tr = '<tr id="tr_' + last_id + '">' +
                ...
                last_id + '" name="_desc[]"  placeholder="Description ' + last_id + '" autocomplete="off"/> </td>' +
