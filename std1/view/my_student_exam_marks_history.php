...
?>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="button" id="btnSubmit" class="btn btn-primary"
                            onClick="showMyStudent(this)">Submit</button>
                        <!--MSK-000108-->
                    </div>
                </div><!-- /.box -->
            </div>
    ...
    function showMyStudent() {
        ...
        if (exam == 'Select Year') {
            ...
            $('#divYear1').append(
                '<span id="spanYear" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The year is required" ></span>'
                );
        ...
        if (exam == 'Select Exam') {
            ...
            $('#divExam1').append(
                '<span id="spanExam" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The exam is required" ></span>'
                );
        ...
        if (grade == 'Select Grade') {
            ...
            $('#divGrade1').append(
                '<span id="spanGrade" class="glyphicon glyphicon-remove form-control-feedback set-width-tooltip" data-toggle="tooltip"    title="The grade is required" ></span>'
                );
        ...
        if (year == 'Select Year' || exam == 'Select Exam' || grade == 'Select Grade') {
            ...
            xhttp.open("GET", "show_my_student1.php?exam=" + exam + "&year=" + year + "&my_index=" + my_index +
                "&grade=" + grade, true);
